...
var RequestMessageBuffer =
    RefArray("uint8", consts.TOX_MAX_FRIEND_REQUEST_LENGTH);
...
var StatusMessageBuffer =
    RefArray("uint8", consts.TOX_MAX_STATUS_MESSAGE_LENGTH);
...
// Tox callback types
var SelfConnectionStatusCallback =
    ffi.Function("void", [ ToxPtr, TOX_CONNECTION, UserData ]);
var FriendNameCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  NameBufferPtr,
  "size_t",
...
var FriendStatusMessageCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  StatusMessageBufferPtr,
  "size_t",
  UserData,
]);
var FriendStatusCallback =
    ffi.Function("void", [ ToxPtr, "uint32", TOX_USER_STATUS, UserData ]);
var FriendConnectionStatusCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  TOX_CONNECTION,
  UserData,
]);
var FriendTypingCallback =
    ffi.Function("void", [ ToxPtr, "uint32", "bool", UserData ]);
var FriendReadReceiptCallback =
    ffi.Function("void", [ ToxPtr, "uint32", "uint32", UserData ]);
var FriendRequestCallback = ffi.Function("void", [
  ToxPtr,
  KeyBufferPtr,
  RequestMessageBufferPtr,
  "size_t",
  UserData,
]);
var FriendMessageCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  TOX_MESSAGE_TYPE,
  MessageBufferPtr,
...
var FileRecvControlCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  "uint32",
  TOX_FILE_CONTROL,
...
var FileChunkRequestCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  "uint32",
  "uint64",
...
var FileRecvCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  "uint32",
  "uint32",
...
var FileRecvChunkCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  "uint32",
  "uint64",
  UnknownSizeBufferPtr,
  "size_t",
  UserData,
]);
var FriendLosslessPacketCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  UInt8Ptr,
  "size_t",
...
var FriendLossyPacketCallback = ffi.Function("void", [
  ToxPtr,
  "uint32",
  UInt8Ptr,
  "size_t",
...
Tox.prototype.createLibrary = function(libpath) {
  ...
  return ffi.Library(libpath, {
    tox_add_tcp_relay : [
      "bool",
      [ ToxPtr, Int8Ptr, "uint16", UInt8Ptr, ref.refType(TOX_ERR_BOOTSTRAP) ],
    ],
    tox_bootstrap : [
      "bool",
      [ ToxPtr, Int8Ptr, "uint16", UInt8Ptr, ref.refType(TOX_ERR_BOOTSTRAP) ]
    ...
    tox_callback_file_chunk_request :
        [ "void", [ ToxPtr, FileChunkRequestCallback, UserData ] ],
    tox_callback_file_recv : [ "void", [ ToxPtr, FileRecvCallback, UserData ] ],
    tox_callback_file_recv_chunk :
        [ "void", [ ToxPtr, FileRecvChunkCallback, UserData ] ],
    tox_callback_file_recv_control :
        [ "void", [ ToxPtr, FileRecvControlCallback, UserData ] ],
    tox_callback_friend_connection_status : [
      "void",
      [ ToxPtr, FriendConnectionStatusCallback, UserData ],
    ],
    tox_callback_friend_message :
        [ "void", [ ToxPtr, FriendMessageCallback, UserData ] ],
    tox_callback_friend_name :
        [ "void", [ ToxPtr, FriendNameCallback, UserData ] ],
    tox_callback_friend_read_receipt :
        [ "void", [ ToxPtr, FriendReadReceiptCallback, UserData ] ],
    tox_callback_friend_request :
        [ "void", [ ToxPtr, FriendRequestCallback, UserData ] ],
    tox_callback_friend_status :
        [ "void", [ ToxPtr, FriendStatusCallback, UserData ] ],
    tox_callback_friend_status_message :
        [ "void", [ ToxPtr, FriendStatusMessageCallback, UserData ] ],
    tox_callback_friend_typing :
        [ "void", [ ToxPtr, FriendTypingCallback, UserData ] ],
    tox_callback_self_connection_status :
        [ "void", [ ToxPtr, SelfConnectionStatusCallback, UserData ] ],
    tox_callback_friend_lossless_packet :
        [ "void", [ ToxPtr, FriendLosslessPacketCallback, UserData ] ],
    tox_callback_friend_lossy_packet :
        [ "void", [ ToxPtr, FriendLossyPacketCallback, UserData ] ],
    tox_file_control : [
      "bool",
      [
        ToxPtr, "uint32", "uint32", TOX_FILE_CONTROL,
        ref.refType(TOX_ERR_FILE_CONTROL)
      ],
    ],
    tox_file_get_file_id : [
      "bool",
      [ ToxPtr, "uint32", "uint32", UInt8Ptr, ref.refType(TOX_ERR_FILE_GET) ],
    ],
    tox_file_seek : [
      "bool",
      [ ToxPtr, "uint32", "uint32", "uint64", ref.refType(TOX_ERR_FILE_SEEK) ]
    ],
    tox_file_send : [
      "uint32",
      [
    ...
    tox_file_send_chunk : [
      ...
      [
        ...
        UInt8Ptr,
        "size_t",
        ref.refType(TOX_ERR_FILE_SEND_CHUNK),
      ],
    ],
    tox_friend_add : [
      "uint32",
      [ ToxPtr, UInt8Ptr, UInt8Ptr, "size_t", ref.refType(TOX_ERR_FRIEND_ADD) ],
    ],
    tox_friend_add_norequest :
        [ "uint32", [ ToxPtr, UInt8Ptr, ref.refType(TOX_ERR_FRIEND_ADD) ] ],
    tox_friend_by_public_key : [
      "uint32",
      [ ToxPtr, UInt8Ptr, ref.refType(TOX_ERR_FRIEND_BY_PUBLIC_KEY) ],
    ],
    tox_friend_delete :
        [ "bool", [ ToxPtr, "uint32", ref.refType(TOX_ERR_FRIEND_DELETE) ] ],
    tox_friend_exists : [ "bool", [ ToxPtr, "uint32" ] ],
    tox_friend_get_connection_status : [
      TOX_CONNECTION,
      [ ToxPtr, "uint32", ref.refType(TOX_ERR_FRIEND_QUERY) ],
    ],
    tox_friend_get_last_online : [
      "uint64",
      [ ToxPtr, "uint32", ref.refType(TOX_ERR_FRIEND_GET_LAST_ONLINE) ],
    ],
    tox_friend_get_name : [
      "bool", [ ToxPtr, "uint32", UInt8Ptr, ref.refType(TOX_ERR_FRIEND_QUERY) ]
    ],
    tox_friend_get_name_size :
        [ "size_t", [ ToxPtr, "uint32", ref.refType(TOX_ERR_FRIEND_QUERY) ] ],
    tox_friend_get_public_key : [
      "uint32",
      [
        ToxPtr, "uint32", UInt8Ptr, ref.refType(TOX_ERR_FRIEND_GET_PUBLIC_KEY)
      ],
    ],
    tox_friend_get_status : [
      TOX_USER_STATUS, [ ToxPtr, "uint32", ref.refType(TOX_ERR_FRIEND_QUERY) ]
    ],
    tox_friend_get_status_message : [
      "bool",
      [ ToxPtr, "uint32", UInt8Ptr, ref.refType(TOX_ERR_FRIEND_QUERY) ],
    ],
    ...
    tox_friend_send_lossless_packet : [
      "bool",
      [
        ToxPtr, "uint32", UInt8Ptr, "size_t",
        ref.refType(TOX_ERR_FRIEND_CUSTOM_PACKET)
      ],
    ],
    ...
    tox_friend_send_message : [
      ...
      [
        ...
        UInt8Ptr,
        "size_t",
        ref.refType(TOX_ERR_FRIEND_SEND_MESSAGE),
      ],
    ],
    ...
    tox_self_get_tcp_port :
        [ "uint16", [ ToxPtr, ref.refType(TOX_ERR_GET_PORT) ] ],
    tox_self_get_udp_port :
        [ "uint16", [ ToxPtr, ref.refType(TOX_ERR_GET_PORT) ] ],
    tox_self_set_name : [
      "bool", [ ToxPtr, UInt8Ptr, "size_t", ref.refType(TOX_ERR_SET_INFO) ]
    ],
    tox_self_set_nospam : [ "void", [ ToxPtr, "uint32" ] ],
    tox_self_set_status : [ "void", [ ToxPtr, TOX_USER_STATUS ] ],
    tox_self_set_status_message : [
      "bool",
      [ ToxPtr, UInt8Ptr, "size_t", ref.refType(TOX_ERR_SET_INFO) ],
    ],
    tox_self_set_typing : [
 ...
 * @param {ToxOptions} opts
 */
Tox.prototype.freeOptionsSync = function(
    opts) { this.getLibrary().tox_options_free(opts.ref()); };
...
Tox.prototype.bootstrap = function(address, port, publicKey, callback) {
  this._performBootstrap({
    api :
        this.getLibrary().tox_bootstrap.async.bind(undefined, this.getHandle()),
...
Tox.prototype.addTCPRelay = function(address, port, publicKey, callback) {
  this._performBootstrap({
    api : this.getLibrary().tox_add_tcp_relay.async.bind(undefined,
                                                         this.getHandle()),
    args : [ address, port, publicKey ],
    async : true,
    callback : callback,
...
Tox.prototype.getAddress = function(callback) {
  this._performGetter({
    api : this.getLibrary().tox_self_get_address.async.bind(undefined,
                                                            this.getHandle()),
    format : "raw",
...
Tox.prototype.getAddressSync = function() {
  return this._performGetter({
    api : this.getLibrary().tox_self_get_address.bind(undefined,
                                                      this.getHandle()),
    format : "raw",
    size : consts.TOX_FRIEND_ADDRESS_SIZE,
  });
...
Tox.prototype.getConnectionStatus = function(callback) {
  this._performNumberGetter({
    api : this.getLibrary().tox_self_get_connection_status.async.bind(
        undefined, this.getHandle()),
    async : true,
    callback : callback,
  });
};
...
Tox.prototype.getConnectionStatusSync = function() {
  return this._performNumberGetter({
    api : this.getLibrary().tox_self_get_connection_status.bind(
        undefined, this.getHandle()),
  });
};
...
Tox.prototype.setNospam = function(nospam, callback) {
  if (!this._checkHandle(callback))
    return;
  this.getLibrary().tox_self_set_nospam.async(this.getHandle(), nospam,
                                              function(err) {
                                                if (callback) {
                                                  callback(err);
                                                }
...
Tox.prototype.getNospam = function(callback) {
  if (!this._checkHandle(callback))
    return;
  this.getLibrary().tox_self_get_nospam.async(this.getHandle(),
                                              function(err, nospam) {
                                                if (callback) {
                                                  callback(err, nospam);
                                                }
...
Tox.prototype.getPublicKey = function(callback) {
  this._performGetter({
    api : this.getLibrary().tox_self_get_public_key.async.bind(
        undefined, this.getHandle()),
    format : "raw",
...
Tox.prototype.getPublicKeySync = function() {
  return this._performGetter({
    api : this.getLibrary().tox_self_get_public_key.bind(undefined,
                                                         this.getHandle()),
    format : "raw",
    size : consts.TOX_PUBLIC_KEY_SIZE,
  });
...
Tox.prototype.getSecretKey = function(callback) {
  this._performGetter({
    api : this.getLibrary().tox_self_get_secret_key.async.bind(
        undefined, this.getHandle()),
    format : "raw",
    size : consts.TOX_PUBLIC_KEY_SIZE,
    async : true,
...
Tox.prototype.getSecretKeySync = function() {
  return this._performGetter({
    api : this.getLibrary().tox_self_get_secret_key.bind(undefined,
                                                         this.getHandle()),
    format : "raw",
...
Tox.prototype.setName = function(name, callback) {
  this._performSetter({
    api : this.getLibrary().tox_self_set_name.async.bind(undefined,
                                                         this.getHandle()),
    data : name,
...
Tox.prototype.getNameSize = function(callback) {
  this._performSizeGetter({
    api : this.getLibrary().tox_self_get_name_size.async.bind(undefined,
                                                              this.getHandle()),
    async : true,
    callback : callback,
  });
...
Tox.prototype.getNameSizeSync = function() {
  return this._performSizeGetter({
    api : this.getLibrary().tox_self_get_name_size.bind(undefined,
                                                        this.getHandle()),
  });
};
...
Tox.prototype.getName = function(callback) {
  this._performGetter({
    api : this.getLibrary().tox_self_get_name.async.bind(undefined,
                                                         this.getHandle()),
    format : "string",
...
Tox.prototype.setStatusMessage = function(statusMessage, callback) {
  this._performSetter({
    api : this.getLibrary().tox_self_set_status_message.async.bind(
        undefined, this.getHandle()),
    data : statusMessage,
    error : errors.setInfo,
    async : true,
...
Tox.prototype.setStatusMessageSync = function(statusMessage) {
  this._performSetter({
    api : this.getLibrary().tox_self_set_status_message.bind(undefined,
                                                             this.getHandle()),
    error : errors.setInfo,
    data : statusMessage,
  });
...
Tox.prototype.getStatusMessageSize = function(callback) {
  this._performSizeGetter({
    api : this.getLibrary().tox_self_get_status_message_size.async.bind(
        undefined, this.getHandle()),
    async : true,
    callback : callback,
  });
...
Tox.prototype.getStatusMessageSizeSync = function() {
  return this._performSizeGetter({
    api : this.getLibrary().tox_self_get_status_message_size.bind(
        undefined, this.getHandle()),
  });
};
...
Tox.prototype.getStatusMessage = function(callback) {
  this._performGetter({
    api : this.getLibrary().tox_self_get_status_message.async.bind(
        undefined, this.getHandle()),
    format : "string",
...
Tox.prototype.getStatusMessageSync = function() {
  return this._performGetter({
    api : this.getLibrary().tox_self_get_status_message.bind(undefined,
                                                             this.getHandle()),
    format : "string",
...
Tox.prototype.setStatus = function(status, callback) {
  this._performNumberSetter({
    api : this.getLibrary().tox_self_set_status.async.bind(undefined,
                                                           this.getHandle()),
    value : status,
    async : true,
    callback : callback,
...
Tox.prototype.setStatusSync = function(status) {
  this._performNumberSetter({
    api :
        this.getLibrary().tox_self_set_status.bind(undefined, this.getHandle()),
    value : status,
  });
};
...
Tox.prototype.getStatus = function(callback) {
  this._performNumberGetter({
    api : this.getLibrary().tox_self_get_status.async.bind(undefined,
                                                           this.getHandle()),
    async : true,
    callback : callback,
  });
...
Tox.prototype.getStatusSync = function() {
  return this._performNumberGetter({
    api :
        this.getLibrary().tox_self_get_status.bind(undefined, this.getHandle()),
  });
};
...
Tox.prototype.addFriendNoRequestSync = function(publicKey) {
  ...
  publicKey = fromHex(publicKey);
  var eptr = ref.alloc(TOX_ERR_FRIEND_ADD),
      friend = this.getLibrary().tox_friend_add_norequest(this.getHandle(),
                                                          publicKey, eptr),
      err = errors.friendAdd(eptr.deref());
  if (err)
    throw err;
...
Tox.prototype.deleteFriendSync = function(friend) {
  ...
  var eptr = ref.alloc(TOX_ERR_FRIEND_DELETE),
      success =
          this.getLibrary().tox_friend_delete(this.getHandle(), friend, eptr);
  var err = errors.friendDelete(eptr.deref());
  if (err)
    throw err;
  if (!success)
    throw errors.unsuccessful();
};
...
Tox.prototype.getFriendByPublicKeySync = function(publicKey) {
  ...
  publicKey = fromHex(publicKey);
  var eptr = ref.alloc(TOX_ERR_FRIEND_BY_PUBLIC_KEY),
      friend = this.getLibrary().tox_friend_by_public_key(this.getHandle(),
                                                          publicKey, eptr);
...
Tox.prototype.getFriendPublicKeySync = function(friend) {
  ...
  var eptr = ref.alloc(TOX_ERR_FRIEND_GET_PUBLIC_KEY),
      buffer = Buffer.alloc(consts.TOX_PUBLIC_KEY_SIZE),
      success = this.getLibrary().tox_friend_get_public_key(
          this.getHandle(), friend, buffer, eptr);
...
Tox.prototype.hasFriend = function(friend, callback) {
  if (!this._checkHandle(callback))
    return;
  this.getLibrary().tox_friend_exists.async(this.getHandle(), friend,
                                            function(err, exists) {
                                              if (callback) {
                                                callback(err, exists);
                                              }
...
Tox.prototype.getFriendLastOnline = function(friend, callback) {
  ...
  this.getLibrary().tox_friend_get_last_online.async(
      this.getHandle(), friend, eptr, function(err, timeval) {
        ...
        var date;
        if (!err)
          date = getDateFromUInt64(timeval);
...
Tox.prototype.getFriendLastOnlineSync = function(friend) {
  this._checkHandle();
  var eptr = ref.alloc(TOX_ERR_FRIEND_GET_LAST_ONLINE),
      timeval = this.getLibrary().tox_friend_get_last_online(this.getHandle(),
                                                             friend, eptr);
...
Tox.prototype.getFriendListSize = function(callback) {
  this._performSizeGetter({
    api : this.getLibrary().tox_self_get_friend_list_size.async.bind(
        undefined, this.getHandle()),
    async : true,
    callback : callback,
  });
...
Tox.prototype.getFriendListSizeSync = function() {
  return this._performSizeGetter({
    api : this.getLibrary().tox_self_get_friend_list_size.bind(
        undefined, this.getHandle()),
  });
};
...
Tox.prototype.getFriendListSync = function() {
  this._checkHandleSync();
  var size = this.getFriendListSizeSync(), arr = new RefArray("uint32")(size);
...
Tox.prototype.getFriendNameSize = function(friend, callback) {
  this._performFriendNumberGetter({
    api : this.getLibrary().tox_friend_get_name_size.async.bind(
        undefined, this.getHandle()),
    friend : friend,
    async : true,
    callback : callback,
...
Tox.prototype.getFriendNameSizeSync = function(friend) {
  return this._performFriendNumberGetter({
    api : this.getLibrary().tox_friend_get_name_size.bind(undefined,
                                                          this.getHandle()),
    friend : friend,
  });
};
...
Tox.prototype.getFriendName = function(friend, callback) {
  this._performFriendGetter({
    api : this.getLibrary().tox_friend_get_name.async.bind(undefined,
                                                           this.getHandle()),
    format : "string",
    friend : friend,
...
Tox.prototype.getFriendNameSync = function(friend) {
  return this._performFriendGetter({
    api :
        this.getLibrary().tox_friend_get_name.bind(undefined, this.getHandle()),
    format : "string",
    friend : friend,
    size : consts.TOX_MAX_NAME_LENGTH,
  });
...
Tox.prototype.getFriendStatusMessageSize = function(friend, callback) {
  this._performFriendNumberGetter({
    api : this.getLibrary().tox_friend_get_status_message_size.async.bind(
        undefined, this.getHandle()),
    friend : friend,
    async : true,
    callback : callback,
...
Tox.prototype.getFriendStatusMessageSizeSync = function(friend) {
  return this._performFriendNumberGetter({
    api : this.getLibrary().tox_friend_get_status_message_size.bind(
        undefined, this.getHandle()),
    friend : friend,
  });
};
...
Tox.prototype.getFriendStatusMessage = function(friend, callback) {
  this._performFriendGetter({
    api : this.getLibrary().tox_friend_get_status_message.async.bind(
        undefined, this.getHandle()),
    format : "string",
    friend : friend,
...
Tox.prototype.getFriendStatusMessageSync = function(friend) {
  return this._performFriendGetter({
    api : this.getLibrary().tox_friend_get_status_message.bind(
        undefined, this.getHandle()),
    format : "string",
    friend : friend,
    size : consts.TOX_MAX_STATUS_MESSAGE_LENGTH,
...
Tox.prototype.getFriendStatus = function(friend, callback) {
  this._performFriendNumberGetter({
    api : this.getLibrary().tox_friend_get_status.async.bind(undefined,
                                                             this.getHandle()),
    friend : friend,
    async : true,
    callback : callback,
...
Tox.prototype.getFriendStatusSync = function(friend) {
  return this._performFriendNumberGetter({
    api : this.getLibrary().tox_friend_get_status.bind(undefined,
                                                       this.getHandle()),
    friend : friend,
  });
};
...
Tox.prototype.getFriendConnectionStatus = function(friend, callback) {
  this._performFriendNumberGetter({
    api : this.getLibrary().tox_friend_get_connection_status.async.bind(
        undefined, this.getHandle()),
    friend : friend,
    async : true,
    callback : callback,
...
Tox.prototype.getFriendConnectionStatusSync = function(friend) {
  return this._performFriendNumberGetter({
    api : this.getLibrary().tox_friend_get_connection_status.bind(
        undefined, this.getHandle()),
    friend : friend,
  });
};
...
Tox.prototype.getUdpPort = function(callback) {
  this._performGetPort({
    api : this.getLibrary().tox_self_get_udp_port.async.bind(undefined,
                                                             this.getHandle()),
    async : true,
    callback : callback,
  });
...
Tox.prototype.getUdpPortSync = function() {
  return this._performGetPort({
    api : this.getLibrary().tox_self_get_udp_port.bind(undefined,
                                                       this.getHandle()),
  });
};
...
Tox.prototype.getTcpPort = function(callback) {
  this._performGetPort({
    api : this.getLibrary().tox_self_get_tcp_port.async.bind(undefined,
                                                             this.getHandle()),
    async : true,
    callback : callback,
  });
...
Tox.prototype.getTcpPortSync = function() {
  return this._performGetPort({
    api : this.getLibrary().tox_self_get_tcp_port.bind(undefined,
                                                       this.getHandle()),
  });
};
...
Tox.prototype.setTypingSync = function(friend, typing) {
  this._checkHandleSync();
  var eptr = ref.alloc(TOX_ERR_SET_TYPING),
      success = this.getLibrary().tox_self_set_typing(this.getHandle(), friend,
                                                      typing, eptr);
...
Tox.prototype.sendFriendMessage = function(friend, message, type, callback) {
  ...
  var args = this._fixSendMessageArgs(friend, message, type), friend = args[0],
      message = args[1], type = args[2],
...
Tox.prototype.controlFileSync = function(friendnum, filenum, control) {
  ...
  control = this._fixFileControl(control);
  var eptr = ref.alloc(TOX_ERR_FILE_CONTROL),
      success = this.getLibrary().tox_file_control(this.getHandle(), friendnum,
                                                   filenum, control, eptr);
...
Tox.prototype.seekFile = function(friendnum, filenum, position, callback) {
  ...
  this.getLibrary().tox_file_seek.async(this.getHandle(), friendnum, filenum,
                                        position, eptr, function(err, success) {
                                          var terr =
                                              errors.fileSeek(eptr.deref());
                                          if (!err && terr)
                                            err = terr;
                                          if (!err && !success)
                                            err = errors.unsuccessful();
...
Tox.prototype.seekFileSync = function(friendnum, filenum, position) {
  this._checkHandleSync();
  var eptr = ref.alloc(TOX_ERR_FILE_SEEK),
      success = this.getLibrary().tox_file_seek(this.getHandle(), friendnum,
                                                filenum, position, eptr);
 ...
 * @param {Tox~numberCallback} [callback]
 */
Tox.prototype.sendFile = function(friendnum, kind, filename, size, fileid,
                                  callback) {
  if (!this._checkHandle(callback))
    return;
  ...
  this.getLibrary().tox_file_send.async(
      this.getHandle(), friendnum, kind, size, fileid, filename,
      filename.length, eptr, function(err, filenum) {
...
Tox.prototype.sendFileSync = function(friendnum, kind, filename, size, fileid) {
  ...
  var eptr = ref.alloc(TOX_ERR_FILE_SEND),
      filenum = this.getLibrary().tox_file_send(this.getHandle(), friendnum,
                                                kind, size, fileid, filename,
                                                filename.length, eptr);
 ...
 * @param {Tox~errorCallback} [callback]
 */
Tox.prototype.sendFileChunk = function(friendnum, filenum, position, data,
                                       callback) {
  if (!this._checkHandle(callback))
    return;
...
Tox.prototype.sendFileChunkSync = function(friendnum, filenum, position, data) {
  ...
  var eptr = ref.alloc(TOX_ERR_FILE_SEND_CHUNK),
      success = this.getLibrary().tox_file_send_chunk(
          this.getHandle(), friendnum, filenum, position, data, data.length,
          eptr);
 ...
 * @param {Number} friendnum
 * @param {Number} [id] - Leading byte in the range [160, 191]
 * @param {Buffer} data
 * @param {Tox~errorCallback} [callback]
 */
Tox.prototype.sendLosslessPacket = function(friendnum, id, data, callback) {
  if (_.isNumber(id)) {
    data = this._fixPacketBuffer(id, data);
  } else {
    callback = data;
    data = id;
  }
  ...
  this._performSendPacket({
    api : this.getLibrary().tox_friend_send_lossless_packet.async.bind(
        undefined, this.getHandle()),
    data : data,
    friend : friendnum,
    async : true,
 ...
 */
Tox.prototype.sendLosslessPacketSync = function(friendnum, id, data) {
  if (_.isNumber(id)) {
    data = this._fixPacketBuffer(id, data);
  } else {
    data = id;
  ...
  this._performSendPacket({
    api : this.getLibrary().tox_friend_send_lossless_packet.bind(
        undefined, this.getHandle()),
    data : data,
    friend : friendnum,
  });
 ...
 * @untested
 * @param {Number} friendnum
 * @param {Number} [id] - Leading byte in the range [200, 254]
 * @param {Buffer} data
 * @param {Tox~errorCallback} [callback]
 */
Tox.prototype.sendLossyPacket = function(friendnum, data, callback) {
  ...
  this._performSendPacket({
    api : this.getLibrary().tox_friend_send_lossy_packet.async.bind(
        undefined, this.getHandle()),
    data : data,
    friend : friendnum,
    async : true,
 ...
 */
Tox.prototype.sendLossyPacketSync = function(friendnum, id, data) {
  if (_.isNumber(id)) {
    data = this._fixPacketBuffer(id, data);
  } else {
    data = id;
  ...
  this._performSendPacket({
    api : this.getLibrary().tox_friend_send_lossy_packet.bind(undefined,
                                                              this.getHandle()),
    data : data,
    friend : friendnum,
  });
...
Tox.prototype.getSavedataSize = function(callback) {
  this._performSizeGetter({
    api : this.getLibrary().tox_get_savedata_size.async.bind(undefined,
                                                             this.getHandle()),
    async : true,
    callback : callback,
  });
...
Tox.prototype.getSavedataSizeSync = function(callback) {
  return this._performSizeGetter({
    api : this.getLibrary().tox_get_savedata_size.bind(undefined,
                                                       this.getHandle()),
  });
};
...
Tox.prototype.getSavedata = function(callback) {
  this._performGetter({
    api : this.getLibrary().tox_get_savedata.async.bind(undefined,
                                                        this.getHandle()),
    format : "raw",
...
/**
 * Get the ToxEncryptSave instance associated with this Tox object,
 * if any.
 * @return {ToxEncryptSave} Crypto handler
 */
Tox.prototype.crypto = function() { return this._crypto; };

/**
 * Get the handle object.
 * @return {Object}
 */
Tox.prototype.getHandle = function() { return this._handle; };

/**
 * Whether or not this Tox instance has a crypto handler.
 * @return {Boolean} true if it has a crypto handler, false if not
 */
Tox.prototype.hasCrypto =
    function() { return this._crypto instanceof ToxEncryptSave; };

/**
 * Whether or not this Tox instance has a handle.
 * @return {Boolean} true if handle, false if none
 */
Tox.prototype.hasHandle = function() { return !!this.getHandle(); };

/**
 * Get the internal Library instance.
 * @return {ffi.Library}
 */
Tox.prototype.getLibrary = function() { return this._library; };
 ...
 */
Tox.prototype.getEmitter = function() { return this._emitter; };
...
Tox.prototype.getOptions = function() {
  ...
  if (ref.address(options.proxy_address) !== 0) {
    proxyAddress =
        ref.reinterpretUntilZeros(options.proxy_address, ref.types.char.size)
            .toString();
  }
 ...
 */
Tox.prototype.isStarted = function() { return !!this._interval; };
 ...
 */
Tox.prototype.on =
    function() { this._emitter.on.apply(this._emitter, arguments); };
...
Tox.prototype.saveToFile = function(filepath, callback) {
  this.getSavedata(function(err, buffer) {
    if (!err) {
      // Using hex number because "grunt jsdoc" doesn't understand octal.
      fs.writeFile(filepath, buffer, {mode : 0x180 /* 0600 */}, callback);
    } else if (callback) {
      callback(err);
    }
  });
...
Tox.prototype.saveToFileSync = function(filepath) {
  // Using hex number because "grunt jsdoc" doesn't understand octal.
  fs.writeFileSync(filepath, this.getSavedataSync(), {
    mode : 0x180 /* 0600 */,
  });
};
...
Tox.prototype.start = function(wait) {
  if (!this.isStarted()) {
    if (isNaN(wait) || wait <= 0)
      wait = 40; // Default milliseconds to wait
 ...
 */
Tox.prototype.getAddressHex = function(
    callback) { util.hexify(this.getAddress.bind(this), callback); };

/**
 * Synchronously get the address as a hex string.
 * @return {String} Address hex string
 */
Tox.prototype.getAddressHexSync =
    function() { return util.hexifySync(this.getAddressSync.bind(this)); };
 ...
 */
Tox.prototype.getPublicKeyHex = function(
    callback) { util.hexify(this.getPublicKey.bind(this), callback); };

/**
 * Synchronously get the public key as a hex string.
 * @return {String} Public key hex string
 */
Tox.prototype.getPublicKeyHexSync =
    function() { return util.hexifySync(this.getPublicKeySync.bind(this)); };

/**
 * Asynchronously get the secret key as a hex string.
 */
Tox.prototype.getSecretKeyHex = function(
    callback) { util.hexify(this.getSecretKey.bind(this), callback); };

/**
 * Synchronously get the secret key as a hex string.
 * @return {String} Secret key hex string
 */
Tox.prototype.getSecretKeyHexSync =
    function() { return util.hexifySync(this.getSecretKeySync.bind(this)); };
...
Tox.prototype._createToxOptions = function(opts) {
  var toxopts = this.newOptionsSync(), ipv6 = opts["ipv6"], udp = opts["udp"],
      startPort = opts["startPort"], endPort = opts["endPort"],
      data = opts["data"], pass = opts["pass"];

  // If pass is a string or Buffer, have pass be a function that returns
  // the string or Buffer
  if (_.isString(pass) || Buffer.isBuffer(pass)) {
    var passData = pass;
  ...
  if (data) {
    if (this.hasCrypto() && _.isFunction(pass) &&
        this.crypto().isDataEncryptedSync(data)) {
      var passphrase = pass();
      data = this.crypto().decryptSync(data, passphrase);
    }
 ...
 */
Tox.prototype._emit =
    function() { this._emitter.emit.apply(this._emitter, arguments); };
...
Tox.prototype._fixSendMessageArgs = function(to, message, type) {
  ...
  if (_.isBoolean(type)) {
    type =
        type ? consts.TOX_MESSAGE_TYPE_ACTION : consts.TOX_MESSAGE_TYPE_NORMAL;
...
/**
 * Initialize the crypto (ToxEncryptSave) object.
 * @param {Object} opts - Tox constructor options object
 * @private
 */
Tox.prototype._initCrypto = function(opts) {
  ...
  } else if (crypto instanceof ToxEncryptSave) {
    // If given an existing instance, use that
    this._crypto = crypto;
  } else if (_.isString(crypto) || _.isObject(crypto)) {
    // If given an object or string, use it as the constructor opts
    this._crypto = new ToxEncryptSave(crypto);
  } else if (!crypto) {
    // If something falsy, don't use
    this._crypto = undefined;
  } else {
    // If something else, use a default instance
    this._crypto = new ToxEncryptSave();
  }
};
...
Tox.prototype._initNew = function(options, data) {
  ...
  if (options) {
    ...
    // If no options passed, use null pointer
    options = ref.NULL;
  }
...
Tox.prototype._setProxyToToxOptions = function(opts, options) {
  ...
  if (_.isObject(proxy)) {
    if (_.isString(proxy.type)) {
      if (/^http$/i.test(proxy.type))
        options.proxy_type = consts.TOX_PROXY_TYPE_HTTP;
      else if (/^socks5?$/i.test(proxy.type))
        options.proxy_type = consts.TOX_PROXY_TYPE_SOCKS5;
    }
...
Tox.prototype._storeFFICallback = function(key, callback) {
  ...
  if (this._ffiCallbacks[key] === undefined)
    ...
    this._ffiCallbacks[key].push(callback);
};
...
Tox.prototype._performBootstrap = function(opts) {
  var api = opts["api"], args = opts["args"], async = opts["async"],
      callback = opts["callback"], address = args[0], port = args[1],
      publicKey = args[2];
...
Tox.prototype._performFriendGetter = function(opts) {
  var api = opts["api"], friend = opts["friend"],
      raw = opts["format"] === "raw", _size = opts["size"],
      async = opts["async"], callback = opts["callback"];

  if (_.isNumber(_size)) {
    var size;
    if (async)
      size = function(cb) { cb(undefined, _size); };
    else
      size = function() { return _size; };
  } else
    size = _size; // Assumes size is a Function
...
Tox.prototype._performFriendNumberGetter = function(opts) {
  var api = opts["api"], friend = opts["friend"], async = opts["async"],
...
Tox.prototype._performGetter = function(opts) {
  var api = opts["api"], raw = opts["format"] === "raw", _size = opts["size"],
      async = opts["async"], callback = opts["callback"];
...
Tox.prototype._performNumberGetter = function(opts) {
  var api = opts["api"], async = opts["async"], callback = opts["callback"];
...
Tox.prototype._performNumberSetter = function(opts) {
  var api = opts["api"], value = opts["value"], async = opts["async"],
      callback = opts["callback"];
 ...
 * @private
 */
Tox.prototype._performSizeGetter = function(
    opts) { return this._performNumberGetter(opts); };
...
Tox.prototype._performSetter = function(opts) {
  var api = opts["api"], data = opts["data"], errorCheck = opts["error"],
      async = opts["async"], callback = opts["callback"];
...
Tox.prototype._performSendPacket = function(opts) {
  var api = opts["api"], data = opts["data"], friendnum = opts["friend"],
      async = opts["async"], callback = opts["callback"];
...
Tox.prototype._initCallback = function(opts) {
  ...
  var api = opts["api"],
      ...
      name = opts["name"], wrapper = opts["wrapper"];
...
Tox.prototype._initSelfConnectionStatusCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_self_connection_status.bind(
        undefined, this.getHandle()),
    cb : SelfConnectionStatusCallback,
    name : "SelfConnectionStatus",
    wrapper : function(handle, connection, userdata) {
      _this._emit("selfConnectionStatus",
                  new toxEvents.SelfConnectionStatusEvent(connection));
    },
  });
};
...
Tox.prototype._initFriendNameCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_name.bind(undefined,
                                                          this.getHandle()),
...
Tox.prototype._initFriendStatusMessageCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_status_message.bind(
        undefined, this.getHandle()),
    cb : FriendStatusMessageCallback,
    name : "FriendStatusMessage",
    wrapper : function(handle, friend, buffer, size, userdata) {
      var statusMessage = buffer.slice(0, size).toString();
      _this._emit("friendStatusMessage", new toxEvents.FriendStatusMessageEvent(
...
Tox.prototype._initFriendStatusCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_status.bind(undefined,
                                                            this.getHandle()),
    cb : FriendStatusCallback,
    name : "FriendStatus",
    wrapper : function(handle, friend, status, userdata) {
      _this._emit("friendStatus",
                  new toxEvents.FriendStatusEvent(friend, status));
    },
  });
};
...
Tox.prototype._initFriendConnectionStatusCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_connection_status.bind(
        undefined, this.getHandle()),
    ...
    wrapper : function(handle, friend, connection, userdata) {
      _this._emit(
          ...
          new toxEvents.FriendConnectionStatusEvent(friend, connection));
    },
  });
};
...
Tox.prototype._initFriendTypingCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_typing.bind(undefined,
                                                            this.getHandle()),
    cb : FriendTypingCallback,
    name : "FriendTypingStatus",
    wrapper : function(handle, friend, typing, userdata) {
      _this._emit("friendTyping",
                  new toxEvents.FriendTypingEvent(friend, typing));
    },
  });
};
...
Tox.prototype._initFriendReadReceiptCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_read_receipt.bind(
        undefined, this.getHandle()),
    cb : FriendReadReceiptCallback,
    name : "FriendReadReceiptStatus",
    wrapper : function(handle, friend, receipt, userdata) {
      _this._emit("friendReadReceipt",
                  new toxEvents.FriendReadReceiptEvent(friend, receipt));
    },
  });
};
...
Tox.prototype._initFriendRequestCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_request.bind(undefined,
                                                             this.getHandle()),
    ...
    wrapper : function(handle, publicKey, data, size, userdata) {
      ...
      _this._emit("friendRequest",
                  new toxEvents.FriendRequestEvent(publicKey, message));
    },
  });
};
...
Tox.prototype._initFriendMessageCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_message.bind(undefined,
                                                             this.getHandle()),
    cb : FriendMessageCallback,
    name : "FriendMessage",
    wrapper : function(handle, friend, type, data, size, userdata) {
      var message = data.slice(0, size).toString();
      _this._emit("friendMessage",
                  new toxEvents.FriendMessageEvent(friend, type, message));
    },
  });
};
...
Tox.prototype._initFileRecvControlCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_file_recv_control.bind(
        undefined, this.getHandle()),
    cb : FileRecvControlCallback,
    name : "FileRecvControlCallback",
    wrapper : function(handle, friend, file, control, userdata) {
      _this._emit("fileRecvControl",
                  new toxEvents.FileRecvControlEvent(friend, file, control));
    },
  });
};
...
Tox.prototype._initFileChunkRequestCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_file_chunk_request.bind(
        undefined, this.getHandle()),
    cb : FileChunkRequestCallback,
    name : "FileChunkRequestCallback",
    wrapper : function(handle, friend, file, position, length, userdata) {
      _this._emit("fileChunkRequest", new toxEvents.FileChunkRequestEvent(
                                          friend, file, position, length));
    },
  });
};
...
Tox.prototype._initFileRecvCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_file_recv.bind(undefined,
                                                        this.getHandle()),
    cb : FileRecvCallback,
    name : "FileRecvCallback",
    wrapper : function(handle, friend, file, kind, size, filename, length,
                       userdata) {
      ...
      _this._emit("fileRecv", new toxEvents.FileRecvEvent(friend, file, kind,
                                                          size, filename));
    },
  });
};
...
Tox.prototype._initFileRecvChunkCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_file_recv_chunk.bind(undefined,
                                                              this.getHandle()),
    ...
    wrapper : function(handle, friend, file, position, data, size, userdata) {
      ...
      if (ref.address(data) !== 0) {
        data =
            Buffer.from(ref.reinterpret(data, size)); // Copy to another Buffer
      } else {
        data = undefined;
      }
      _this._emit("fileRecvChunk", new toxEvents.FileRecvChunkEvent(
                                       friend, file, position, data));
    },
  });
};
...
Tox.prototype._initFriendLosslessPacketCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_lossless_packet.bind(
        undefined, this.getHandle()),
    ...
    wrapper : function(handle, friend, data, length, userdata) {
      ...
      //  data = Buffer.from(ref.reinterpret(data, (length - 1), 1)); // Copy to
      //  another Buffer
      //} else {
      //  data = undefined;
      //}
      ...
      _this._emit("friendLosslessPacket",
                  new toxEvents.FriendPacketEvent(friend, data, true));
    },
  });
};

/**
 * Initialize the friendLossyPacket event callback.
 * @private
 */
Tox.prototype._initFriendLossyPacketCb = function() {
  var _this = this;
  this._initCallback({
    api : this.getLibrary().tox_callback_friend_lossy_packet.bind(
        undefined, this.getHandle()),
    ...
    wrapper : function(handle, friend, data, length, userdata) {
      ...
      data = Buffer.from(ref.reinterpret(data, length));
      _this._emit("friendLossyPacket",
                  new toxEvents.FriendPacketEvent(friend, data, false));
    },
  });
};
